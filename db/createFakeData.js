...
var generateAndWriteData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var i, dbFilePath, dataToWrite;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                for (i = 0; i < NUM_FAKE_ACCOUNTS; i++) {
                    generateAccount(profilesCount(), campaignsCount());
                }
                dbFilePath = './db/db.json';
                dataToWrite = {
                    accounts: accounts,
                    profiles: profiles,
                    campaigns: campaigns,
